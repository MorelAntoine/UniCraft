...
{
	[CreateAssetMenu(menuName = "UniCraft/Character/Condition/Input/Action/Negative/IsNotAttemptingToJump")]
	public class IsNotAttemptingToJumpCondition : AMotionCondition
	{

...
{
	[CreateAssetMenu(menuName = "UniCraft/Character/Condition/Input/Action/Positive/IsAttemptingToCrouch")]
	public class IsAttemptingToCrouchCondition : AMotionCondition
	{

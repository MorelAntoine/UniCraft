...
{
	[CreateAssetMenu(menuName = "UniCraft/Character/Condition/Input/IsCrouchButtonHeld")]
	public class IsCrouchButtonHeld : AMotionCondition
	{
		////////////////////////////
		////////// Method //////////
		////////////////////////////
		...
		{
			return (inputInformation.CrouchButtonValue);
		}

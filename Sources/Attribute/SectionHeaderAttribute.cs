...
namespace UniCraft.Attribute
{
	...
	public class HeaderSectionDrawer : DecoratorDrawer
	{
		...
		private const float LabelAlignOffset = 8f;
		...
		private void DrawEmptyHeaderSection(Rect guiPosition)
		{
			...
			guiPosition.y += GuiStartY + _sectionHeaderAttribute.SpaceBefore;
			GUI.Box(guiPosition, "");
		}
		...
		private void DrawHeaderSection(Rect guiPosition)
		{
			...
			guiPosition.Set(guiPosition.xMin + _labelFieldWidth + LabelPadding, guiPosition.yMin - LabelAlignOffset,
			...
			guiPosition.Set(guiPosition.xMin + _sectionHeaderAttribute.LabelSize.x + LabelPadding,
				guiPosition.yMin + LabelAlignOffset, _labelFieldWidth - LabelPadding - LabelPadding, 1);
			GUI.Box(guiPosition, "");
		}
	}
}
